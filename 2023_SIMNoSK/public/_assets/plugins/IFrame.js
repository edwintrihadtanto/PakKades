/**
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      //var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><div id=\"" + uniqueName + "\"></div><div class=\"form-group\"><label for=\"exampleInputEmail1\">Input 1</label><input type=\"text\" name=\"file1\" class=\"form-control\"></div></div>";
      //var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><div id=\"" + uniqueName + "\"><div class=\"form-group\"><label for=\"exampleInputEmail1\">\"" + uniqueName + "\"</label><input type=\"text\" name=\"file1\" class=\"form-control\"></div></div></div>";
