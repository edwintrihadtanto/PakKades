...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Lanjut",sPrevious:"Kembali"},sEmptyTable:"Tidak ada data yang ditampilkan",sInfo:"Ditampilkan _START_ sampai _END_ dari _TOTAL_ data<br>",sInfoEmpty:"Ditampilkan 0 sampai 0 dari 0 data<br>",sInfoFiltered:"(terfilter dari _MAX_ data)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Tampilkan _MENU_ data",sLoadingRecords:"Loading...",sProcessing:"Sedang memuat data...",sSearch:"Pencarian:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Tidak ditemukan data..."},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
